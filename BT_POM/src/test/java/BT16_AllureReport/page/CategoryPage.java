...
public class CategoryPage {
    ...
    public void clickButtonAddNew() {
        WebUI1.clickElement(buttonAddNewCategory);
    }
    ...
    public void inputDataCategory(String categoryName) {
        WebUI1.setText(inputNameCategory,categoryName);

        WebUI1.clickElement(dropdownParentCategory);
        WebUI1.setText(searchParentCategory,"QuynhNN");
        WebUI1.sleep(1);
        driver.findElement(searchParentCategory).sendKeys(Keys.ENTER);

        WebUI1.setText(inputOrderingNumber,"12345");

        WebUI1.clickElement(dropdownTypeCategory);
        WebUI1.clickElement(selectTypeCateGory);

        WebUI1.clickElement(chooseBannerImage);
        WebUI1.waitForElementVisible(selectImage1);
        WebUI1.clickElement(selectImage1);
        WebUI1.clickElement(buttonAddFileImage);

        WebUI1.setText(inputMetaTitle,"Giay kieu moi");
        WebUI1.setText(inputMetaDescription,"Giay bong dep");

        WebUI1.clickElement(dropdownFilterAttribute);
        WebUI1.clickElement(selectValueFilterAttribute);

        WebUI1.clickElement(buttonSaveCategory);
    }
