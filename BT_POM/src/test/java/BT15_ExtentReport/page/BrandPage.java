...
public class BrandPage {
    ...
    public void inputDataBrand(String brandName, String titleBrand, String descriptionBrand) {
        ...
        WebUI1.setText(inputNameBrand, brandName);
        WebUI1.clickElement(chooseImageLogo);
        WebUI1.clickElement(By.xpath("//div[@title='Profile AnhTester 512px.jpg']"));
        WebUI1.clickElement(By.xpath("//button[normalize-space()='Add Files']"));
        WebUI1.setText(inputMetaTitle, titleBrand);
        WebUI1.setText(inputMetaDescription, descriptionBrand);
        WebUI1.sleep(2);
        WebUI1.clickElement(buttonSaveBrand);
    }
    ...
    public void searchBrand(String nameBrand) {
        WebUI1.setText(inputSearchBrand, nameBrand);
        // WebUI1.clickElement(firstItemListBrand);
    }

    public void editBrand() {
        WebUI1.clickElement(optionEditBrand);
    }

    public void editDataBrand(String brandName, String titleBrand, String descriptionBrand) {
        driver.findElement(inputNameBrand).clear();
        WebUI1.setText(inputNameBrand, brandName);
        WebUI1.clickElement(editImageLogo);
        WebUI1.clickElement(By.xpath("//div[@title='Profile AnhTester 512px.jpg']"));
        WebUI1.clickElement(By.xpath("//button[normalize-space()='Add Files']"));
    ...
    public void deleteBrand() {
        WebUI1.clickElement(optionDeleteBrand);
        WebUI1.clickElement(confirmDeleteBrand);
    }
