...
public class LoginPage {
    ...
    private void clickbuttonLogin() {
        ...
        LogUtils.info("Click button Login: " + buttonLogin);
    }
    ...
    public void verifyLoginFail() {
        ...
        Assert.assertEquals(driver.findElement(errorEmailMessage).getText(), "Invalid login credentials1");
    }
    ...
    public void verifyLoginFail_WithNullEmailField() {
       ...
       LogUtils.info(validationMessage);
        Assert.assertEquals(validationMessage, "Please fill out this field.  1", "The validation message of Email field not match.");
    }
    ...
    public void verifyLoginFail_WithNullPasswordField() {
        ...
        String validationMessage = inputElement.getAttribute("validationMessage");
       LogUtils.info(validationMessage);
        Assert.assertEquals(validationMessage, "Please fill out this field. 1 ", "The validation message of Password field not match.");
    }
