...
public class ProductPage {
    ...
    private By firstIconProductEdit = By.xpath("(//a[@title='Edit'])[1]");
    ...
    private By buttonNextPage = By.xpath("//a[@aria-label='Next »']");
    private By totalPage = By.xpath("//ul[@class='pagination']");
    ...
    public void searchProductTable(String companyName) {
        WebUI.setText(inputSearchCategoryProduct, companyName);
        WebUI.sleep(2);
        WebUI.clickElement(firstItemOnProductTable);
    }
    ...
    public void searchProduct() {
        WebUI.setText(inputSearchProduct, "Áo thun");
...
// lay so luong page dua vao class pagination, va class ben trong - 2
// vi du sl-page = 6-2 = 4
// 2 : lay so luong san pham tren 1 page
//3: lay so luong san pham tren 1 page x so page - 1
// vi du: 15 x (4-1) = 45
// click vao page cuoi
// vao page cuoi dem so luong san pham + 45 :